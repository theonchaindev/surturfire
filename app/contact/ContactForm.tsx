...
export default function ContactForm() {
  ...
  if (submitted) {
    return (
      <div style={{ padding: "48px 40px", textAlign: "center", border: "1px solid var(--line)", background: "#fff" }}>
        ...
        <h3 style={{ fontSize: "1.25rem", fontWeight: 700, color: "var(--black)", marginBottom: "8px" }}>Message received.</h3>
        <p style={{ fontSize: "0.9rem", color: "var(--grey)" }}>We&apos;ll be in touch within one business day.</p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      ...
      <div>
        ...
        <textarea required rows={5} placeholder="Tell us about your fire safety requirements..." value={form.message} onChange={(e) => set("message", e.target.value)} className="field" style={{ resize: "vertical" }} />
      </div>
      <button type="submit" disabled={submitting} className="btn-red" style={{ width: "fit-content" }}>
